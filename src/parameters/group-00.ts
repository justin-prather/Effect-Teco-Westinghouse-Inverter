...
const all = {
  ...
  "00-00": P.pe(GROUP_00_Basic_Parameters["00-00"], {
    0: "V/F",
    1: "V/F+PG",
    2: "SLV",
    3: "SV",
  ...
  "00-01": P.pe(GROUP_00_Basic_Parameters["00-01"], {
    0: "Forward",
    1: "Reverse",
  } as const, {
    group,
  ...
  "00-02": P.pe(GROUP_00_Basic_Parameters["00-02"], {
    0: "Keypad",
    1: "External Terminal",
  ...
  "00-03": P.pe(GROUP_00_Basic_Parameters["00-03"], {
    0: "Keypad",
    1: "External Terminal",
    2: "Communication (RS-485)",
    3: "PLC",
  ...
  "00-04": P.pe(GROUP_00_Basic_Parameters["00-04"], {
    0: "English",
  ...
  "00-05": P.pe(GROUP_00_Basic_Parameters["00-05"], {
    0: "Keypad",
  ...
  "00-06": P.pe(GROUP_00_Basic_Parameters["00-06"], {
    0: "Keypad",
    1: "External Terminal (Analog1)",
    2: "Terminal Command UP/DOWN",
    3: "Communication (RS-485)",
  ...
  "00-07": P.pe(GROUP_00_Basic_Parameters["00-07"], {
    0: "Main Frequency",
  ...
  "00-09": P.pe(GROUP_00_Basic_Parameters["00-09"], {
  ...
  "00-10": P.pe(GROUP_00_Basic_Parameters["00-10"], {
  ...
  "00-11": P.pe(GROUP_00_Basic_Parameters["00-11"], {
  ...
  "00-27": P.pe(GROUP_00_Basic_Parameters["00-27"], {
  ...
  "00-28": P.pe(GROUP_00_Basic_Parameters["00-28"], {
  ...
  "00-29": P.pe(GROUP_00_Basic_Parameters["00-29"], {
  ...
  "00-32": P.pe(GROUP_00_Basic_Parameters["00-32"], {
    0: "General",
    2: "Conveyor",
    3: "Exhaust Fan",
    5: "Compressor",
  ...
  "00-33": P.pe(GROUP_00_Basic_Parameters["00-33"], {
    0: "Disable",
    1: "Enable",
  } as const, {
    group,
  ...
  "00-57": P.pe(GROUP_00_Basic_Parameters["00-57"], {
  ...
  "00-08": P.sp(GROUP_00_Basic_Parameters["00-08"], 0.01, {
    group,
    code: "00-08",
  ...
  "00-18": P.sp(GROUP_00_Basic_Parameters["00-18"], 0.01, {
    group,
    code: "00-18",
    name: "Jog Frequency",
    range: "0.00~599.00",
  ...
  "00-25": P.sp(GROUP_00_Basic_Parameters["00-25"], 0.01, {
    group,
    code: "00-25",
  ...
  "00-12": P.sp(GROUP_00_Basic_Parameters["00-12"], 0.1, {
    group,
    code: "00-12",
  ...
  "00-13": P.sp(GROUP_00_Basic_Parameters["00-13"], 0.1, {
    group,
    code: "00-13",
  ...
  "00-14": P.sp(GROUP_00_Basic_Parameters["00-14"], 0.1, {
    group,
    code: "00-14",
  ...
  "00-15": P.sp(GROUP_00_Basic_Parameters["00-15"], 0.1, {
    group,
    code: "00-15",
  ...
  "00-16": P.sp(GROUP_00_Basic_Parameters["00-16"], 0.1, {
    group,
    code: "00-16",
  ...
  "00-17": P.sp(GROUP_00_Basic_Parameters["00-17"], 0.1, {
    group,
    code: "00-17",
  ...
  "00-19": P.sp(GROUP_00_Basic_Parameters["00-19"], 0.1, {
    group,
    code: "00-19",
  ...
  "00-20": P.sp(GROUP_00_Basic_Parameters["00-20"], 0.1, {
    group,
    code: "00-20",
  ...
  "00-21": P.sp(GROUP_00_Basic_Parameters["00-21"], 0.1, {
    group,
    code: "00-21",
  ...
  "00-22": P.sp(GROUP_00_Basic_Parameters["00-22"], 0.1, {
    group,
    code: "00-22",
  ...
  "00-23": P.sp(GROUP_00_Basic_Parameters["00-23"], 0.1, {
    group,
    code: "00-23",
  ...
  "00-24": P.sp(GROUP_00_Basic_Parameters["00-24"], 0.1, {
    group,
    code: "00-24",
  ...
  "00-26": P.sp(GROUP_00_Basic_Parameters["00-26"], 0.1, {
    group,
    code: "00-26",
  ...
  "00-41": P.p(GROUP_00_Basic_Parameters["00-41"], {
    group,
    code: "00-41",
  ...
  "00-42": P.p(GROUP_00_Basic_Parameters["00-42"], {
    group,
    code: "00-42",
  ...
  "00-43": P.p(GROUP_00_Basic_Parameters["00-43"], {
    group,
    code: "00-43",
  ...
  "00-44": P.p(GROUP_00_Basic_Parameters["00-44"], {
    group,
    code: "00-44",
  ...
  "00-45": P.p(GROUP_00_Basic_Parameters["00-45"], {
    group,
    code: "00-45",
  ...
  "00-46": P.p(GROUP_00_Basic_Parameters["00-46"], {
    group,
    code: "00-46",
  ...
  "00-47": P.p(GROUP_00_Basic_Parameters["00-47"], {
    group,
    code: "00-47",
  ...
  "00-48": P.p(GROUP_00_Basic_Parameters["00-48"], {
    group,
    code: "00-48",
  ...
  "00-49": P.p(GROUP_00_Basic_Parameters["00-49"], {
    group,
    code: "00-49",
  ...
  "00-50": P.p(GROUP_00_Basic_Parameters["00-50"], {
    group,
    code: "00-50",
  ...
  "00-51": P.p(GROUP_00_Basic_Parameters["00-51"], {
    group,
    code: "00-51",
  ...
  "00-52": P.p(GROUP_00_Basic_Parameters["00-52"], {
    group,
    code: "00-52",
  ...
  "00-53": P.p(GROUP_00_Basic_Parameters["00-53"], {
    group,
    code: "00-53",
  ...
  "00-54": P.p(GROUP_00_Basic_Parameters["00-54"], {
    group,
    code: "00-54",
  ...
  "00-55": P.p(GROUP_00_Basic_Parameters["00-55"], {
    group,
    code: "00-55",
  ...
  "00-56": P.p(GROUP_00_Basic_Parameters["00-56"], {
    group,
    code: "00-56",
