...
export declare const decodeCommandWord: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeCommandWord: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedCommandWord: (a: any) => string;
...
export declare const decodeFrequencyCommand: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeFrequencyCommand: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedFrequencyCommand: (a: any) => string;
export declare const FrequencyCommandSchema: Schema.Schema<FrequencyHz, number, never>;
export declare const decodeTorqueCommand: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeTorqueCommand: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedTorqueCommand: (a: any) => string;
export declare const TorqueCommandSchema: Schema.Schema<TorquePercent, number, never>;
export declare const decodeSpeedLimitCommand: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeSpeedLimitCommand: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedSpeedLimitCommand: (a: any) => string;
export declare const SpeedLimitCommandSchema: Schema.Schema<SpeedLimitPercent, number, never>;
export declare const decodeAnalogOut1Command: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeAnalogOut1Command: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedAnalogOut1Command: (a: any) => string;
export declare const AnalogOut1CommandSchema: Schema.Schema<Voltage, number, never>;
export declare const decodeAnalogOut2Command: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeAnalogOut2Command: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedAnalogOut2Command: (a: any) => string;
...
export declare const decodeDigitalOutCommand: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const encodeDigitalOutCommand: (a: any, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedDigitalOutCommand: (a: any) => string;
...
export declare const decodeStateMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedStateMonitor: (a: any) => string;
export declare const decodeErrorDescriptionMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedErrorDescriptionMonitor: (a: any) => string;
...
export declare const decodeDigitalInStateMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedDigitalInStateMonitor: (a: any) => string;
export declare const decodeFrequencyCommandMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedFrequencyCommandMonitor: (a: any) => string;
export declare const FrequencyCommandMonitorSchema: Schema.Schema<FrequencyHz, number, never>;
export declare const decodeOutputFrequencyMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedOutputFrequencyMonitor: (a: any) => string;
export declare const OutputFrequencyMonitorSchema: Schema.Schema<FrequencyHz, number, never>;
export declare const decodeDCBusVoltageCommandMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedDCBusVoltageCommandMonitor: (a: any) => string;
export declare const DCBusVoltageCommandMonitorSchema: Schema.Schema<DCBusVoltage, number, never>;
export declare const decodeOutputCurrentMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedOutputCurrentMonitor: (a: any) => string;
export declare const OutputCurrentMonitorSchema: Schema.Schema<CurrentAmps, number, never>;
export declare const decodeWarningDescriptionMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedWarningDescriptionMonitor: (a: any) => string;
...
export declare const decodeDigitalOutStateMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedDigitalOutStateMonitor: (a: any) => string;
export declare const decodeAnalogOut1Monitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedAnalogOut1Monitor: (a: any) => string;
export declare const AnalogOut1MonitorSchema: Schema.Schema<Voltage, number, never>;
export declare const decodeAnalogOut2Monitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedAnalogOut2Monitor: (a: any) => string;
export declare const AnalogOut2MonitorSchema: Schema.Schema<Voltage, number, never>;
export declare const decodeAnalogIn1Monitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedAnalogIn1Monitor: (a: any) => string;
export declare const AnalogIn1MonitorSchema: Schema.Schema<AnalogInputPercent, number, never>;
export declare const decodeAnalogIn2Monitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedAnalogIn2Monitor: (a: any) => string;
export declare const AnalogIn2MonitorSchema: Schema.Schema<AnalogInputPercent, number, never>;
export declare const decodeA510CheckMonitor: (u: unknown, overrideOptions?: import("effect/SchemaAST").ParseOptions) => import("effect/Effect").Effect<any, import("effect/ParseResult").ParseError, never>;
export declare const formattedA510CheckMonitor: (a: any) => string;
